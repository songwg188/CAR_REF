...
def make_model(args, parent=False):
    return MemNet(in_channels=args.in_channel, channels=64, num_memblock=6, num_resblock=6)


class MemNet(nn.Module):
    def __init__(self, in_channels, channels, num_memblock, num_resblock):
        # include 6 Memory blocks, ecah block contains 6 Recursive units(ResBlock), channels:64 batch_size = 64 data_size = 31
